...
//        static constexpr std::arrayCardColor
    ...
    namespace Silent {
        ...
        static constexpr std::array<Card, 19> commonCardPool = { Card::CLOAK_AND_DAGGER, Card::SNEAKY_STRIKE, Card::DEADLY_POISON, Card::DAGGER_SPRAY, Card::BANE, Card::BLADE_DANCE, Card::DEFLECT, Card::DAGGER_THROW, Card::POISONED_STAB, Card::ACROBATICS, Card::QUICK_SLASH, Card::SLICE, Card::BACKFLIP, Card::OUTMANEUVER, Card::PREPARED, Card::PIERCING_WAIL, Card::SUCKER_PUNCH, Card::DODGE_AND_ROLL, Card::FLYING_KNEE };
